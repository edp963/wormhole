...
import edp.wormhole.sparkx.swifts.custom.sensors.{SensorsDataTransform, SensorsDataUpdateDbSchema}
import edp.wormhole.sparkxinterface.swifts.{SparkConfig, WormholeConfig}
import org.apache.spark.{SparkConf, SparkContext}
import org.apache.spark.sql.{Dataset, SparkSession}

object SensorDataUpdateTest extends App {
  ...
  val df0=sparkSession.read.json(ds)
  df0.show()
  ...
  val param1:String="{\"projectId\":15,\"mysqlConnUrl\":\"jdbc:mysql://hdp1:3306/test\",\"mysqlUser\":\"root\",\"mysqlPassword\":\"root\",\"mysqlDatabase\":\"test\",\"duration\":0,\"dataTypeConst\":[\"0\",\"\",\"\",\"0\",\"0\",\"-1\"]}"
  val transform1:SensorsDataTransform=new SensorsDataTransform()
  val df1=transform1.transform(sparkSession,df0,null,param1,config,sourceNs,sinkNs)
  df1.show()

  val param2 = "{\"clickHouseConnUrl\":\"jdbc:clickhouse://10.143.151.220:8123\",\"clickHouseUser\":\"root\",\"clickHousePassword\":\"root\",\"clickHouseDatabase\":\"event_data\",\"clickHouseTableName\":\"event_wos_p15\",\"clickHouseCluster\":\"bip_ck_cluster\"}"
  val transform2:SensorsDataUpdateDbSchema=new SensorsDataUpdateDbSchema()
  val df2=transform2.transform(sparkSession,df1,null,param2,config,sourceNs,sinkNs)
  df2.show()
  println("end")
}
