...
object JsonProtocol extends DefaultJsonProtocol with SprayJsonSupport {
  ...
  implicit val formatActionClass: RootJsonFormat[ActionClass] = jsonFormat4(ActionClass)
  ...
  implicit val formatSimpleTopic: RootJsonFormat[SimpleTopic] = jsonFormat5(SimpleTopic)
  implicit val formatStreamUser: RootJsonFormat[Stream] = jsonFormat19(Stream)
  implicit val formatTopicUser: RootJsonFormat[TopicSimple] = jsonFormat3(TopicSimple)
  ...
  implicit val formatStreamKafkaTopic: RootJsonFormat[StreamKafkaTopic] = jsonFormat5(StreamKafkaTopic)
  ...
  implicit val formatStreamIntopic: RootJsonFormat[StreamInTopic] = jsonFormat12(StreamInTopic)
  ...
  implicit val formatKafkaUser: RootJsonFormat[Kafka] = jsonFormat2(Kafka)
  implicit val formatTopicDetailUser: RootJsonFormat[TopicDetail] = jsonFormat14(TopicDetail)
  ...
  implicit val formatRiderSpark: RootJsonFormat[RiderSpark] = jsonFormat22(RiderSpark)
  implicit val formatRiderMonitor: RootJsonFormat[RiderMonitor] = jsonFormat6(RiderMonitor)
//  implicit val formatRiderInfo: RootJsonFormat[RiderInfo] = jsonFormat5(RiderInfo)
