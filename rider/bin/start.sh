...
java -Xmx4G -DWORMHOLE_HOME=$WORMHOLE_HOME $WORMHOLE_KERBEROS_PARAM -cp $WORMHOLE_HOME/lib/wormhole-rider-server_1.3-0.6.0.jar:$WORMHOLE_HOME/lib/* edp.rider.RiderStarter &
