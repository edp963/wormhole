...
class UmsFlatMapper(sourceSchemaMap: Map[String, (TypeInformation[_], Int)], config:WormholeFlinkxConfig, sourceNamespace: String, jsonSourceParseMap: Map[(UmsProtocolType, String), (Seq[UmsField], Seq[FieldInfo], ArrayBuffer[(String, String)])], sinkNamespace:String, mConfig:Configuration) extends ProcessFunction[(String, String, String, Int, Long), Row] with Serializable {
